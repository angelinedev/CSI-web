          ...
          {events.map((event, index) => (
            <ScrollAnimator key={index} delay={index * 100} animationClassName="animate-fade-in-up">
               <div className="relative group">
                ...
                <Card className="relative overflow-hidden transform group-hover:-translate-y-2 transition-transform duration-500 ease-in-out shadow-md group-hover:shadow-xl h-full flex flex-col is-visible:-translate-y-2 is-visible:shadow-xl">
                  <CardHeader className="p-0 relative">
                    <Image
                      ...
                      width={600}
                      height={400}
                      className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500 ease-in-out is-visible:scale-105"
